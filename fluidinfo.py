...
def call(method, path, body=None, mime=None, tags=[], custom_headers={}, **kw):
    ...
    **kw = Query-string arguments to be appended to the URL
	...
	# the following three lines replace the http.request to give us a 10 seconds deadline
	#responseobject = urlfetch.fetch(url=url, method=method, payload=body, headers=headers, deadline=10)
	#response = responseobject.headers
	#content = responseobject.content
	# end of jonas' modifications
